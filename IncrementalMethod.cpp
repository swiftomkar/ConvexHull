 ...
 */
int IncrementalMethod::firstFacet(const vector<SmartPoint>& points) {
    SmartFacet facet1(5);
    int pointsIndex = 0;
 ...
 */
void IncrementalMethod::cone(const SmartPoint& tip, std::vector<Edge>& edges) {
 ...
 * 
 */
void IncrementalMethod::setHorizon(vector<Edge>& horizon, const SmartPoint& star) {
 ...
 */
void IncrementalMethod::updateConflifctGraph(const vector<Edge>& horizon, SmartPoint& departingStar) {
 ...
 */
void IncrementalMethod::removeDisabledFacets() {
    int shift = 0;
